                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a
                                    href="${pageContext.request.contextPath}/Admin/product/image-add">Quản lý ảnh</a>
                            </li>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="card card-info">
                                        ...
                                        <div class="card-body">
                                            <form role="form"
                                                  action="${pageContext.request.contextPath}/Admin/product/image-add?id=${id}"
                                                  method="post">
                                                <!-- Date dd/mm/yyyy -->
                                                <!-- /.form group -->
                                                <!-- phone mask -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="image1" id="avatar">
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="button" value="Tải ảnh lên"
                                                               onclick="BrowseServer1();" class="btn btn-controls"/>
                                                        <input type="text" name="image2" id="avatar1">
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="button" value="Tải ảnh lên"
                                                               onclick="BrowseServer2();" class="btn btn-controls"/>
                                                        <input type="text" name="image3" id="avatar2">
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                                <!-- /.form group -->
...
<script type="text/javascript">
    function BrowseServer1() {
        ...
        finder.basePath = "/CKLibraries/ckfinder";
        finder.selectActionFunction = function (fileUrl) {
            document.getElementById('avatar1').value = fileUrl;
        };
        finder.popup();
    }
</script>
<script type="text/javascript">
    function BrowseServer2() {
        ...
        finder.basePath = "/CKLibraries/ckfinder";
        finder.selectActionFunction = function (fileUrl) {
            document.getElementById('avatar2').value = fileUrl;
        };
        finder.popup();
    }
</script>
