        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                ...
                <div class="features_items"><!--features_items-->
                    ...
                    <div id="contentProduct" style="padding: 32px 0;"></div>
                    ...
                    <ul class="pagination">
                        <c:if test="${currentPage != 1}">
                            <li class="page-item"><a class="page-link"
                                                     href="?name=${name}&page=${currentPage-1}">&laquo;</a>
                            </li>
                        </c:if>
                        ...
                        <c:if test="${currentPage lt numOfPages}">
                            <li class="page-item"><a class="page-link"
                                                     href="?name=${name}&page=${currentPage+1}">&raquo;</a>
                            </li>
                        </c:if>
                    </ul>
                </div><!--features_items-->
